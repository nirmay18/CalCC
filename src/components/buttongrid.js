...
export default function ButtonGrid({onNumberPress, onOperatorPress, onClear, onAllClear, onEqual}) {
  return (
    <View style={styles.grid}>
      <View style={styles.row}>
        <TouchableOpacity onPress={onAllClear} style={styles.operatorbutton}>
          <Text style={styles.buttonText}>AC</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => onOperatorPress("%")} style={styles.operatorbutton}>
          <Text style={styles.buttonText}>%</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={onClear} style={styles.operatorbutton}>
      ...
      <View style={styles.row}>
        ...
        <TouchableOpacity onPress={() => onOperatorPress("*")} style={styles.operatorbutton}><Text style={styles.buttonText}>×</Text></TouchableOpacity>
      </View>
      ...
      <View style={styles.row}>
        ...
        <TouchableOpacity onPress={onEqual} style={styles.operatorbutton}><Text style={styles.buttonText}>=</Text></TouchableOpacity>
      </View>
    </View>
  );
}
